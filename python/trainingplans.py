...
triathlon = {'olympic':
             ...
             [Week(REST, TrainingItem('Swim 40 min', '40 minute easy swim, taking breaks as needed'),
                   ...
                   TrainingItem('Bike 75 min', 'WU 10 minutes (easy spinning), 60 minute medium effort, 5 minute cool down'),
              ...
              Week(REST, TrainingItem('Swim 40 min', '40 minute easy swim, taking breaks as needed'),
                   ...
                   TrainingItem('Run 60 min', 'WU 10 minutes (brisk walk), 50 minute easy run')),
              # week 4
              Week(REST, TrainingItem('Swim 60 min', '10 minute WU, swim 4x 200 at a medium-hard effort with 1 minute recovery between sets, CD 5 minutes easy'),
                   REST, TrainingItem('Bike 75 min', 'WU 10 minutes easy spinning, 60 minutes easy effort, 5 minute CD'),
                   REST, TrainingItem('Run 75 min', 'WU 10 minutes (brisk walk), 60 minutes easy to medium effort, 5 minute CD'),
                   REST),
              # week 5
              Week(REST, TrainingItem('Swim 60 min', 'WU 10 minutes, swim 4x 250 at a medium effort with 1 minute recovery between sets, CD 5 minutes easy'),
                   TrainingItem('Bike 70 min', 'Easy 70 minute bike ride'),
                   TrainingItem('Run 60 min', 'WU 10 minutes (easy jog), 45 minute easy run with 10 min hard in the middle, 5 minute CD'),
                   TrainingItem('Swim 60 min', 'WU 10 minutes, 4x25 sprints, 30 minutes easy spin, CD 5 minutes'),
                   TrainingItem('Bike 115 min', 'WU 10 minutes (easy spinning), 100 minute medium effort, 5 minute cool down'),
              ...
              Week(REST, TrainingItem('Swim 60 min', 'WU 10 minutes, swim 4x 250 at a medium effort with 1 minute recovery between sets, CD 5 minutes easy'),
                   ...
                   TrainingItem('Bike 135 min', 'WU 10 minutes (easy spinning), 120 minute medium effort, 5 minute cool down'),
                   TrainingItem('Run 85 min', 'WU 10 minutes (easy jog), 70 minute easy run, 5 minute CD')),
              # week 7
              Week(REST, TrainingItem('Swim 60 min', 'WU 10 minutes, swim 4x 250 at a medium effort with 1 minute recovery between sets, CD 5 minutes easy'),
                   TrainingItem('Bike 70 min', 'Easy 70 minute bike ride'),
                   TrainingItem('Run 60 min', 'WU 10 minutes (easy jog), 45 minute easy run with 10 min hard in the middle, 5 minute CD'),
                   TrainingItem('Swim 60 min', 'WU 10 minutes, 6x25 sprints, 40 minutes easy spin, CD 5 minutes'),
                   TrainingItem('Bike 160 min', 'WU 10 minutes (easy spinning), 140 minutes medium with 10 minutes in the middle at hard effort, 5 minutes CD'),
                   TrainingItem('Run 95 min', 'WU 10 minutes (easy jog), 80 minute easy run, 5 minute CD')),
              # week 8
              Week(REST, TrainingItem('Swim 60 min', 'WU 10 minutes, 30 minutes steady race effort, 10 minute easy swim, CD 5 minutes '),
                   REST, TrainingItem('Run 60 min', 'WU 10 minutes (easy jog), 45 minute easy run, 5 minute CD'),
                   REST, TrainingItem('Bike 200 min', 'WU 10 minutes (easy spinning), 180 minutes sustained medium effort, 10 minutes CD'),
                   REST),
              # week 9
              Week(REST, TrainingItem('Swim 60 min', 'WU 10 minutes, 4x 300 medium effort with 1 minute recovery between sets, CD 5 minutes'),
                   TrainingItem('Bike 70 min', 'Easy 70 minute bike ride'),
                   ...
                   TrainingItem('Brick 175 min', 'Bike 10 minutes easy spinning, 150 minutes moderated spinning, 5 minute CD. Immediately transition to running shoes and run 10 minutes easy'),
                   TrainingItem('Run 40 min', 'WU 10 minutes (brisk walk), 30 minute easy run')),
              # week 10
              Week(REST, TrainingItem('Swim 60 min', 'WU 10 minutes, 4x 350 medium effort with 1 minute recovery between sets, CD 5 minutes'),
                   TrainingItem('Bike 60 min', 'Easy 60 minute bike ride'),
                   TrainingItem('Run 65 min', 'WU 10 minutes (brisk jog), easy 50 minute run with 10 minutes hard in the middle, 5 minute CD'),
                   TrainingItem('Swim 60 min', 'WU 10 minutes, 4x50 sprints, Spin 35 min easy'),
                   TrainingItem('Brick 195 min', 'Bike 10 minutes easy spinning, 160 minutes moderated spinning, 10 minute CD. Immediately transition to running shoes and run 10 minutes easy'),
                   TrainingItem('Run 50 min', 'WU 10 minutes (brisk walk), 40 minute easy run')),
              # week 11
              Week(REST, TrainingItem('Swim 60 min', 'WU 10 minutes, 4x 300 easy/medium effort with 1 minute recovery between sets, CD 5 minutes'),
                   TrainingItem('Bike 45 min', 'Medium effort 45 minute bike ride'),
                   TrainingItem('Run 55 min', 'WU 10 minutes (easy jog), easy 40 minute run, 5 minute CD'),
                   TrainingItem('Swim 60 min', 'WU 10 minutes, 5x25 sprints, 35 minutes easy spin, CD 5 minutes'),
                   TrainingItem('Brick 130 min', 'Bike 10 minutes easy spinning, 120 minutes moderated spinning, 5 minute CD. Immediately transition to running shoes and run 10 minutes easy'),
                   TrainingItem('Run 40 min', 'WU 10 minutes (brisk walk), 30 minute easy run')),
              # week 12
              Week(REST, TrainingItem('Run 30 min', '10 minute WU (walk or slow jog), 15 minute easy run, 5 minute CD'),
                   TrainingItem('Bike 45 min', '45 minute easy spinning'),
                   TrainingItem('Swim 60 min', 'WU 5 minutes, 4x 200 at easy effort with 1 minute recovery between sets, 5 minute CD'), REST,
